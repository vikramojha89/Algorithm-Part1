/*
* Weighted Quick Union with Path Compression, improvement over naive algorithm
...
class PCWeightedQuickUnion
{
public:
    PCWeightedQuickUnion(int n)
    {
        len = n;
        id = new int[len];
        sz = new int[len];
